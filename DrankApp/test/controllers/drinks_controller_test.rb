...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { alcohol_id: @drink.alcohol_id, directions: @drink.directions, name: @drink.name } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { alcohol_id: @drink.alcohol_id, directions: @drink.directions, name: @drink.name } }
